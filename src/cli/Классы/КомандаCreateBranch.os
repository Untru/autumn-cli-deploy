...
&КомандаПриложения(Имя = "CreateBranch", Описание = "Создает новую ветку, при этом если в названии ветки 
|                                        hot - считаем, что это префикс хот фикс - и тогда создаем ветку от main")
