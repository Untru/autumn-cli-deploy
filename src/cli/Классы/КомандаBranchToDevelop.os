...
&КомандаПриложения(Имя = "BranchToDevelop", Описание = "Переходит на девелоп, блокирует базу, если нужно, обновляет базу из 
|                                        хранилища, а так же обновляет обработки и расширения")
