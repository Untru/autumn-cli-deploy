...
Процедура ОбработатьКоманду() Экспорт
	...
	Если _КомандыПараметры.ВернутьСвойство("UpdateDB") Тогда
		...
		//Сообщить(" Старт: Подключение к хранилищу " + ТекущаяДата());
		//_КомандыКонфигуратор.ПодключитьсяКХранилищу();
		//Сообщить(" Конец: Подключение к хранилищу " + ТекущаяДата());

		Сообщить(" Старт: Обновление конфигурации из хранилища " + ТекущаяДата());
		_КомандыКонфигуратор.ОбновитьБазуИзХранилища();
		Сообщить(" Конец: Обновление конфигурации из хранилища " + ТекущаяДата());
