...
Процедура ОбработатьКоманду() Экспорт
	...
	Если _КомандыПараметры.ВернутьСвойство("UpdateDB") Тогда
		...
		//Лог.Информация(" Старт: Подключение к хранилищу " + ТекущаяДата());
		//_КомандыКонфигуратор.ПодключитьсяКХранилищу();
		//Лог.Информация(" Конец: Подключение к хранилищу " + ТекущаяДата());

		Лог.Информация(" Старт: Обновление конфигурации из хранилища " + ТекущаяДата());
		_КомандыКонфигуратор.ОбновитьБазуИзХранилища();
		Лог.Информация(" Конец: Обновление конфигурации из хранилища " + ТекущаяДата());
