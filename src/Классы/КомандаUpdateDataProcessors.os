...
Процедура ОбработатьКоманду() Экспорт
	...
	Для Каждого ОбновляемаяБД Из ДанныеОбновляемыхБД Цикл
		...
		Сообщить(" Старт: Перенос обработок в базу рабочую " + ОбновляемаяБД.База + " " + ТекущаяДата());
		...
		Сообщить(" Конец: Перенос обработок в базу рабочую " + ОбновляемаяБД.База + " " + ТекущаяДата());
