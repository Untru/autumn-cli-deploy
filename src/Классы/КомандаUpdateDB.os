...
Процедура ОбработатьКоманду() Экспорт
	...
	Лог.Информация(" Старт: Обновление базы из хранилища " + ТекущаяДата());
	_КомандыКонфигуратор.ОбновитьБазуИзХранилища(); // todo
	Лог.Информация(" Конец: Обновление базы из хранилища " + ТекущаяДата());
	
	
	Лог.Информация(" Старт: Обновление расширений из хранилища " + ТекущаяДата());
	_КомандыКонфигуратор.РасширениеПолучитьИзХранилища(); // todo
	Лог.Информация(" Конец: Обновление расширений из хранилища " + ТекущаяДата());
