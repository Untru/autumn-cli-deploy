...
Процедура ОбработатьКоманду() Экспорт
	...
	Лог.Информация(" Старт: Обновление базы из хранилища");
	_КомандыКонфигуратор.ОбновитьБазуИзХранилища(); // todo
	Лог.Информация(" Конец: Обновление базы из хранилища");
	
	
	Лог.Информация(" Старт: Обновление расширений из хранилища");
	_КомандыКонфигуратор.РасширениеПолучитьИзХранилища(); // todo
	Лог.Информация(" Конец: Обновление расширений из хранилища");
