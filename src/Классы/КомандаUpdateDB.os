...
Процедура ОбработатьКоманду() Экспорт
	...
	Сообщить(" Старт: Обновление базы из хранилища " + ТекущаяДата());
	_КомандыКонфигуратор.ОбновитьБазуИзХранилища(); // todo
	Сообщить(" Конец: Обновление базы из хранилища " + ТекущаяДата());
	
	
	Сообщить(" Старт: Обновление расширений из хранилища " + ТекущаяДата());
	_КомандыКонфигуратор.РасширениеПолучитьИзХранилища(); // todo
	Сообщить(" Конец: Обновление расширений из хранилища " + ТекущаяДата());
