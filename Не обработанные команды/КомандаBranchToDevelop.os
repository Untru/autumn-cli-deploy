...
Процедура ОбработатьКоманду() Экспорт
	...
	Если _КомандыПараметры.ВернутьСвойство("UpdateDB") Тогда
		...
		//Лог.Информация(" Старт: Подключение к хранилищу");
		//_КомандыКонфигуратор.ПодключитьсяКХранилищу();
		//Лог.Информация(" Конец: Подключение к хранилищу");

		Лог.Информация(" Старт: Обновление конфигурации из хранилища");
		_КомандыКонфигуратор.ОбновитьБазуИзХранилища();
		Лог.Информация(" Конец: Обновление конфигурации из хранилища");
